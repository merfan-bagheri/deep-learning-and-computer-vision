...
import supervision as sv  # For ByteTrack
...
class DeepByteTrack:
    def __init__(self, detections,
        ...
        self.reid_model = reid_model = CustomCBAMNet(num_classes=200) 
    ...
    def deepbytetrack(self, 
        ...
        with open(output_path, 'w') as f:
            for frame_num, detection in tqdm(enumerate(self.detections), total=len(self.detections), desc="DeepByteTrack Processing"):
